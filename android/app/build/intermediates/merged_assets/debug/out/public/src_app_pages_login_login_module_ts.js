...
let LoginPage = class LoginPage {
    ...
    onNext() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__awaiter)(this, void 0, void 0, function* () {
            ...
            this.api.login({ name: this.name, mobile: this.mobile }).then((data) => {
                console.log(data);
                if (data.status == 200) {
                    this.otpdiv = true;
                }
    ...
    OTPVerify() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__awaiter)(this, void 0, void 0, function* () {
            ...
            console.log('->', otpPin);
            this.commonService.showLoader();
            this.api.verify_otp({ mobile: this.mobile, otp: otpPin }).then((data) => {
                console.log(data);
                setTimeout(() => {
