...
/* harmony import */ var _pages_shared_form_modal_shared_form_modal_page__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./pages/shared-form-modal/shared-form-modal.page */ 72818);
...
/* harmony import */ var _ionic_storage_angular__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @ionic/storage-angular */ 17897);
...
/* harmony import */ var _services_error_handler_alert_type_enum__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./services/error-handler/alert-type.enum */ 78747);
/* harmony import */ var _awesome_cordova_plugins_email_composer_ngx__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @awesome-cordova-plugins/email-composer/ngx */ 76097);
...
let AppComponent = class AppComponent {
    constructor(storage, platform, router, menuCtrl, modalCtrl, actionSheetCtrl, call, email, commonService, api) {
        ...
        this.api = api;
        this.openCapacitorSite = () => (0,tslib__WEBPACK_IMPORTED_MODULE_9__.__awaiter)(this, void 0, void 0, function* () {
            yield _capacitor_browser__WEBPACK_IMPORTED_MODULE_5__.Browser.open({ url: 'http://capacitorjs.com/', presentationStyle: 'fullscreen' });
        });
    }
    ngOnInit() {
    ...
    openModal(flag) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_9__.__awaiter)(this, void 0, void 0, function* () {
            const modal = yield this.modalCtrl.create({
                component: _pages_shared_form_modal_shared_form_modal_page__WEBPACK_IMPORTED_MODULE_4__.SharedFormModalPage,
    ...
    getContactInfo() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_9__.__awaiter)(this, void 0, void 0, function* () {
            this.api.contactInfo().then((data) => {
                console.log(data);
                if (data.status == 200) {
                    this.contactNumber = data.data[0].support_mobile;
                    this.contactEmail = data.data[0].support_email;
                }
            }).catch(err => {
                this.commonService.showAlert(_services_error_handler_alert_type_enum__WEBPACK_IMPORTED_MODULE_7__.AlertTypeEnum.Error, err.message);
            });
        });
    }
    onContact() {
                ...
                buttons: [
                    {
                        ...
                        handler: () => {
                            this.call.callNumber(`${this.contactNumber}`, true).then((data) => {
                                ...
                                this.commonService.showAlert(_services_error_handler_alert_type_enum__WEBPACK_IMPORTED_MODULE_7__.AlertTypeEnum.Error, 'Something went wrong!');
                            });
                        }
                    },
                    {
...
AppComponent.ctorParameters = () => [
    ...
    { type: _awesome_cordova_plugins_email_composer_ngx__WEBPACK_IMPORTED_MODULE_8__.EmailComposer },
    { type: _services_common_service__WEBPACK_IMPORTED_MODULE_3__.CommonService },
    { type: _services_api_service__WEBPACK_IMPORTED_MODULE_2__.ApiService }
];
AppComponent.propDecorators = {
    routerOutlet: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_13__.ViewChild, args: [_ionic_angular__WEBPACK_IMPORTED_MODULE_11__.IonRouterOutlet, { static: true },] }]
};
...
let ApiService = class ApiService {
    constructor(storage, requestManager, commonService) {
        ...
        this.getRecommendations = () => (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__awaiter)(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                this, this.requestManager.get('recommendedList').subscribe((data) => {
                    resolve(data);
                }, (err) => {
                    console.log(err);
                    reject(new _error_handler_error_handler__WEBPACK_IMPORTED_MODULE_2__.Error(err.errors, err.status));
...
let RequestManagerService = class RequestManagerService {
    constructor(http) {
        this.http = http;
        this.url = 'https://www.theninjacare.com/api/v1/';
    }
...
const environment = {
    production: false,
    baseURL: 'http://192.168.68.140:8001'
};
/*
